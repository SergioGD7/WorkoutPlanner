      ...
      <CardContent>
        <div className="space-y-3">
          {workoutExercise.sets.map((set, index) => (
            <div key={index} className="flex items-center justify-between rounded-lg bg-secondary/10 border border-secondary/20 p-3 hover:bg-secondary/20 transition-colors">
